...
int main(int argc, char *argv[]){
	...
	if(latestVersion==RETURN_ERROR){
		...
		if(latestVersion){
			...
			printf("%sout-of-date.%s You can execute 'auditing-cybersecurity --update' or download the latest version from: https://github.com/Lucho-A/Auditing-Cybersecurity/releases/latest\n",C_HRED,C_DEFAULT);
		}
	}
