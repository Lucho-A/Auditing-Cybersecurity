...
static int dpiOci__loadLibValidate(dpiVersionInfo *versionInfo, dpiError *error);
...
typedef int (*dpiOciFnType__arrayDescriptorFree)(void **descp,
		const uint32_t type);
typedef int (*dpiOciFnType__attrGet)(const void *trgthndlp, uint32_t trghndltyp,
		void *attributep, uint32_t *sizep, uint32_t attrtype, void *errhp);
...
typedef int (*dpiOciFnType__bindByName)(void *stmtp, void **bindp, void *errhp,
		...
		uint16_t *rcodep, uint32_t maxarr_len, uint32_t *curelep, uint32_t mode);
typedef int (*dpiOciFnType__bindByName2)(void *stmtp, void **bindp, void *errhp,
		const char *placeholder, int32_t placeh_len, void *valuep,
...
typedef int (*dpiOciFnType__collAssignElem)(void *env, void *err, int32_t index,
		const void *elem, const void *elemind, void *coll);
typedef int (*dpiOciFnType__collGetElem)(void *env, void *err, const void *coll,
		int32_t index, int *exists, void **elem, void **elemind);
...
typedef int (*dpiOciFnType__dateTimeConstruct)(void *hndl, void *err,
		...
		uint8_t mm, uint8_t ss, uint32_t fsec, const char *tz, size_t tzLength);
...
typedef int (*dpiOciFnType__defineByPos)(void *stmtp, void **defnp, void *errhp,
		uint32_t position, void *valuep, int32_t value_sz, uint16_t dty,
		void *indp, uint16_t *rlenp, uint16_t *rcodep, uint32_t mode);
...
typedef int (*dpiOciFnType__defineObject)(void *defnp, void *errhp,
		const void *type, void **pgvpp, uint32_t *pvszsp, void **indpp,
		uint32_t *indszp);
typedef int (*dpiOciFnType__describeAny)(void *svchp, void *errhp, void *objptr,
		uint32_t objnm_len, uint8_t objptr_typ, uint8_t info_level,
		uint8_t objtyp, void *dschp);
typedef int (*dpiOciFnType__descriptorAlloc)(const void *parenth, void **descpp,
...
typedef int (*dpiOciFnType__envNlsCreate)(void **envp, uint32_t mode,
		...
		size_t xtramem_sz, void **usrmempp, uint16_t charset, uint16_t ncharset);
...
typedef int (*dpiOciFnType__lobGetLength2)(void *svchp, void *errhp, void *locp,
		uint64_t *lenp);
typedef int (*dpiOciFnType__lobIsOpen)(void *svchp, void *errhp, void *locp,
		int *flag);
typedef int (*dpiOciFnType__lobIsTemporary)(void *envp, void *errhp, void *locp,
		int *is_temporary);
...
typedef int (*dpiOciFnType__objectFree)(void *env, void *err, void *instance,
		uint16_t flags);
typedef int (*dpiOciFnType__objectGetAttr)(void *env, void *err, void *instance,
		void *null_struct, void *tdo, const char **names,
...
typedef int (*dpiOciFnType__objectNew)(void *env, void *err, const void *svc,
		uint16_t typecode, void *tdo, void *table, uint16_t duration, int value,
		void **instance);
typedef int (*dpiOciFnType__objectPin)(void *env, void *err, void *object_ref,
		...
		void **object);
typedef int (*dpiOciFnType__objectSetAttr)(void *env, void *err, void *instance,
		void *null_struct, void *tdo, const char **names,
		const uint32_t *lengths, const uint32_t name_count,
		const uint32_t *indexes, const uint32_t index_count,
...
typedef int (*dpiOciFnType__serverDetach)(void *srvhp, void *errhp,
		uint32_t mode);
typedef int (*dpiOciFnType__serverRelease)(void *hndlp, void *errhp, char *bufp,
		uint32_t bufsz, uint8_t hndltype, uint32_t *version);
typedef int (*dpiOciFnType__serverRelease2)(void *hndlp, void *errhp,
		char *bufp, uint32_t bufsz, uint8_t hndltype, uint32_t *version,
		uint32_t mode);
typedef int (*dpiOciFnType__sessionBegin)(void *svchp, void *errhp, void *usrhp,
		uint32_t credt, uint32_t mode);
...
typedef int (*dpiOciFnType__shardingKeyColumnAdd)(void *shardingKey,
		...
		uint32_t mode);
typedef int (*dpiOciFnType__sodaBulkInsert)(void *svchp, void *collection,
		void **documentarray, uint32_t arraylen, void *opoptns, void *errhp,
		uint32_t mode);
typedef int (*dpiOciFnType__sodaBulkInsertAndGet)(void *svchp, void *collection,
		void **documentarray, uint32_t arraylen, void *opoptns, void *errhp,
		uint32_t mode);
...
typedef int (*dpiOciFnType__sodaFind)(void *svchp, const void *coll,
		const void *findOptions, uint32_t docFlags, void **cursor, void *errhp,
		uint32_t mode);
...
typedef int (*dpiOciFnType__subscriptionRegister)(void *svchp, void **subscrhpp,
		uint16_t count, void *errhp, uint32_t mode);
typedef int (*dpiOciFnType__subscriptionUnRegister)(void *svchp, void *subscrhp,
		void *errhp, uint32_t mode);
...
typedef int (*dpiOciFnType__tableSize)(void *env, void *err, const void *tbl,
		int32_t *size);
typedef int (*dpiOciFnType__threadKeyDestroy)(void *hndl, void *err, void **key);
...
static const char *dpiOciLibNames[] = {
    ...
    "libclntsh.dylib.21.1",
		...
		"libclntsh.so.12.1", "libclntsh.so.11.1", "libclntsh.so.20.1",
		"libclntsh.so.21.1",
#endif
		NULL };
...
//-----------------------------------------------------------------------------
int dpiOci__attrSet(void *handle, uint32_t handleType, void *ptr, uint32_t size,
		uint32_t attribute, const char *action, dpiError *error) {
	int status;
...
int dpiOci__bindByName(dpiStmt *stmt, void **bindHandle, const char *name,
	...
	status = (*dpiOciSymbols.fnBindByName)(stmt->handle, bindHandle,
			...
			var->type->oracleType, (dynamicBind) ? NULL : var->buffer.indicator,
			(dynamicBind || var->type->sizeInBytes) ?
					NULL : var->buffer.actualLength16,
...
int dpiOci__bindByName2(dpiStmt *stmt, void **bindHandle, const char *name,
	...
	status = (*dpiOciSymbols.fnBindByName2)(stmt->handle, bindHandle,
			...
			var->type->oracleType, (dynamicBind) ? NULL : var->buffer.indicator,
			(dynamicBind || var->type->sizeInBytes) ?
					NULL : var->buffer.actualLength32,
			(dynamicBind) ? NULL : var->buffer.returnCode,
			(var->isArray) ? var->buffer.maxArraySize : 0,
			(var->isArray) ? &var->buffer.actualArraySize : NULL,
			(dynamicBind) ? DPI_OCI_DATA_AT_EXEC : DPI_OCI_DEFAULT);
...
int dpiOci__collAssignElem(dpiConn *conn, int32_t index, const void *elem,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnCollAssignElem)(conn->env->handle, error->handle,
			index, elem, elemInd, coll);
...
int dpiOci__collSize(dpiConn *conn, void *coll, int32_t *size, dpiError *error) {
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnCollSize)(conn->env->handle, error->handle, coll,
			size);
...
int dpiOci__dateTimeSubtract(void *envHandle, void *handle1, void *handle2,
	...
	DPI_OCI_LOAD_SYMBOL("OCIDateTimeSubtract", dpiOciSymbols.fnDateTimeSubtract)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__defineByPos(dpiStmt *stmt, void **defineHandle, uint32_t pos,
	...
	status = (*dpiOciSymbols.fnDefineByPos)(stmt->handle, defineHandle,
			error->handle, pos,
			(var->isDynamic) ? NULL : var->buffer.data.asRaw,
			(var->isDynamic) ? INT_MAX : (int32_t) var->sizeInBytes,
			var->type->oracleType,
			(var->isDynamic) ? NULL : var->buffer.indicator,
...
int dpiOci__errorGet(void *handle, uint32_t handleType, uint16_t charsetId,
	...
	status = (*dpiOciSymbols.fnErrorGet)(handle, 1, NULL, &error->buffer->code,
			error->buffer->message, sizeof(error->buffer->message), handleType);
	if (status != DPI_OCI_SUCCESS)
	...
	if (charsetId == DPI_CHARSET_ID_UTF16) {
		...
		error->buffer->messageLength = (uint32_t) strlen(
...
int dpiOci__intervalGetDaySecond(void *envHandle, int32_t *day, int32_t *hour,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnIntervalGetDaySecond)(envHandle, error->handle,
...
//-----------------------------------------------------------------------------
int dpiOci__intervalGetYearMonth(void *envHandle, int32_t *year, int32_t *month,
		const void *interval, dpiError *error) {
	int status;
...
//-----------------------------------------------------------------------------
int dpiOci__jsonDomDocGet(dpiJson *json, dpiJznDomDoc **domDoc, dpiError *error) {
	int status;
...
static int dpiOci__loadLibWithName(dpiOciLoadLibParams *loadParams,
	...
	if (!loadParams->handle) {
		...
		if (dpiUtils__ensureBuffer(strlen(osError) + 1,
				"allocate load error buffer", (void**) &loadParams->errorBuffer,
				&loadParams->errorBufferLength, error) < 0)
			return DPI_FAILURE;
...
static int dpiOci__loadLibWithOracleHome(dpiOciLoadLibParams *loadParams,
	...
	if (dpiUtils__allocateMemory(1, oracleHomeLength + 5, 0,
			"allocate ORACLE_HOME dir name", (void**) &oracleHomeLibDir, error)
			< 0)
		return DPI_FAILURE;
...
int dpiOci__loadLib(dpiContextCreateParams *params,
	...
	static const char *envNamesToCheck[] = { "ORACLE_HOME", "ORA_TZFILE",
			"TNS_ADMIN",
#ifdef _WIN32
        "PATH",
#else
	...
	if (status < 0 && (int) error->buffer->errorNum == 0) {
		...
		dpiError__set(error, "load library", DPI_ERR_LOAD_LIBRARY, bits,
				loadLibParams.loadError, params->loadErrorUrl);
	}
...
static int dpiOci__loadLibValidate(dpiVersionInfo *clientVersionInfo,
	...
	(*dpiOciSymbols.fnClientVersion)(&clientVersionInfo->versionNum,
			&clientVersionInfo->releaseNum, &clientVersionInfo->updateNum,
...
int dpiOci__lobFreeTemporary(dpiConn *conn, void *lobLocator, int checkError,
	...
	DPI_OCI_LOAD_SYMBOL("OCILobFreeTemporary", dpiOciSymbols.fnLobFreeTemporary)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnLobFreeTemporary)(conn->handle, error->handle,
			lobLocator);
	if (!checkError)
		return DPI_SUCCESS;
...
int dpiOci__lobLocatorAssign(dpiLob *lob, void **copiedHandle, dpiError *error) {
	...
	DPI_OCI_LOAD_SYMBOL("OCILobLocatorAssign", dpiOciSymbols.fnLobLocatorAssign)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__lobRead2(dpiLob *lob, uint64_t offset, uint64_t *amountInBytes,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	charsetId =
			(lob->type->charsetForm == DPI_SQLCS_NCHAR) ?
...
int dpiOci__numberFromInt(const void *value, unsigned int valueLength,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnNumberFromInt)(error->handle, value, valueLength,
			flags, number);
...
int dpiOci__objectPin(void *envHandle, void *objRef, void **obj,
	...
	NULL, DPI_OCI_PIN_ANY, DPI_OCI_DURATION_SESSION, DPI_OCI_LOCK_NONE, obj);
...
int dpiOci__objectSetAttr(dpiObject *obj, dpiObjectAttr *attr,
	...
	status = (*dpiOciSymbols.fnObjectSetAttr)(obj->env->handle, error->handle,
			obj->instance, obj->indicator, obj->type->tdo, &attr->name,
			&attr->nameLength, 1, NULL, 0, scalarValueIndicator, valueIndicator,
			value);
...
int dpiOci__serverRelease(dpiConn *conn, char *buffer, uint32_t bufferSize,
	...
	if (conn->env->versionInfo->versionNum < 18) {
		...
		DPI_OCI_LOAD_SYMBOL("OCIServerRelease2", dpiOciSymbols.fnServerRelease2)
...
//-----------------------------------------------------------------------------
int dpiOci__sessionBegin(dpiConn *conn, uint32_t credentialType, uint32_t mode,
		dpiError *error) {
	int status;
...
int dpiOci__sessionPoolDestroy(dpiPool *pool, uint32_t mode, int checkError,
	...
	handle = pool->handle;
	pool->handle = NULL;
	status = (*dpiOciSymbols.fnSessionPoolDestroy)(handle, error->handle, mode);
	if (checkError && DPI_OCI_ERROR_OCCURRED(status)) {
		pool->handle = handle;
...
int dpiOci__sessionRelease(dpiConn *conn, const char *tag, uint32_t tagLength,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnSessionRelease)(conn->handle, error->handle, tag,
			tagLength, mode);
	if (!checkError)
		return DPI_SUCCESS;
...
int dpiOci__shardingKeyColumnAdd(void *shardingKey, void *col, uint32_t colLen,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnShardingKeyColumnAdd)(shardingKey, error->handle,
			col, colLen, colType, DPI_OCI_DEFAULT);
...
int dpiOci__sodaBulkInsert(dpiSodaColl *coll, void **documents,
	...
	status = (*dpiOciSymbols.fnSodaBulkInsert)(coll->db->conn->handle,
			coll->handle, documents, numDocuments, outputOptions, error->handle,
			mode);
...
int dpiOci__sodaCollCreateWithMetadata(dpiSodaDb *db, const char *name,
	...
	status = (*dpiOciSymbols.fnSodaCollCreateWithMetadata)(db->conn->handle,
			...
			mode);
	DPI_OCI_CHECK_AND_RETURN(error, status, db->conn, "create SODA collection");
}
...
int dpiOci__sodaCollOpen(dpiSodaDb *db, const char *name, uint32_t nameLength,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnSodaCollOpen)(db->conn->handle, name, nameLength,
			handle, error->handle, mode);
...
int dpiOci__sodaCollTruncate(dpiSodaColl *coll, dpiError *error) {
	...
	DPI_OCI_LOAD_SYMBOL("OCISodaCollTruncate", dpiOciSymbols.fnSodaCollTruncate)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__sodaDataGuideGet(dpiSodaColl *coll, void **handle, uint32_t mode,
	...
	DPI_OCI_LOAD_SYMBOL("OCISodaDataGuideGet", dpiOciSymbols.fnSodaDataGuideGet)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__sodaFind(dpiSodaColl *coll, const void *options, uint32_t flags,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnSodaFind)(coll->db->conn->handle, coll->handle,
			options, flags, handle, error->handle, mode);
	if (status == DPI_OCI_NO_DATA) {
		*handle = NULL;
		return DPI_SUCCESS;
	}
...
int dpiOci__sodaFindOne(dpiSodaColl *coll, const void *options, uint32_t flags,
	...
	DPI_OCI_CHECK_AND_RETURN(error, status, coll->db->conn, "get SODA document");
}
...
int dpiOci__sodaInsert(dpiSodaColl *coll, void *handle, uint32_t mode,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnSodaInsert)(coll->db->conn->handle, coll->handle,
			handle, error->handle, mode);
	DPI_OCI_CHECK_AND_RETURN(error, status, coll->db->conn,
...
int dpiOci__sodaInsertAndGet(dpiSodaColl *coll, void **handle, uint32_t mode,
	...
	DPI_OCI_LOAD_SYMBOL("OCISodaInsertAndGet", dpiOciSymbols.fnSodaInsertAndGet)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__sodaInsertAndGetWithOpts(dpiSodaColl *coll, void **handle,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnSodaInsertAndGetWithOpts)(coll->db->conn->handle,
...
int dpiOci__sodaOperKeysSet(const dpiSodaOperOptions *options, void *handle,
	...
	status = (*dpiOciSymbols.fnSodaOperKeysSet)(handle, options->keys,
			...
			DPI_OCI_DEFAULT);
	DPI_OCI_CHECK_AND_RETURN(error, status, NULL, "set operation options keys");
}
...
int dpiOci__sodaRemove(dpiSodaColl *coll, void *options, uint32_t mode,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnSodaRemove)(coll->db->conn->handle, coll->handle,
			options, count, error->handle, mode);
	DPI_OCI_CHECK_AND_RETURN(error, status, coll->db->conn,
...
int dpiOci__sodaSave(dpiSodaColl *coll, void *handle, uint32_t mode,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnSodaSave)(coll->db->conn->handle, coll->handle,
			handle, error->handle, mode);
	DPI_OCI_CHECK_AND_RETURN(error, status, coll->db->conn,
			"save SODA document");
}
...
int dpiOci__stmtFetch2(dpiStmt *stmt, uint32_t numRows, uint16_t fetchMode,
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnStmtFetch2)(stmt->handle, error->handle, numRows,
			fetchMode, offset, DPI_OCI_DEFAULT);
...
int dpiOci__stmtRelease(dpiStmt *stmt, const char *tag, uint32_t tagLength,
	...
	if (stmt->deleteFromCache) {
		dpiOci__attrGet(stmt->conn->handle, DPI_OCI_HTYPE_SVCCTX, &cacheSize,
				NULL, DPI_OCI_ATTR_STMTCACHESIZE, NULL, error);
		if (cacheSize > 0)
...
int dpiOci__stringAssignText(void *envHandle, const char *value,
	...
	DPI_OCI_LOAD_SYMBOL("OCIStringAssignText", dpiOciSymbols.fnStringAssignText)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__tableExists(dpiObject *obj, int32_t index, int *exists,
	...
	DPI_OCI_CHECK_AND_RETURN(error, status, obj->type->conn, "get index exists");
}
...
int dpiOci__tableFirst(dpiObject *obj, int32_t *index, dpiError *error) {
	...
	status = (*dpiOciSymbols.fnTableFirst)(obj->env->handle, error->handle,
			obj->instance, index);
	DPI_OCI_CHECK_AND_RETURN(error, status, obj->type->conn, "get first index");
}
...
int dpiOci__threadKeyDestroy(void *envHandle, void *errorHandle, void **key,
		dpiError *error) {
	DPI_OCI_LOAD_SYMBOL("OCIThreadKeyDestroy", dpiOciSymbols.fnThreadKeyDestroy)
...
int dpiOci__transCommit(dpiConn *conn, uint32_t flags, dpiError *error) {
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnTransCommit)(conn->handle, error->handle, flags);
...
int dpiOci__transDetach(dpiConn *conn, uint32_t flags, dpiError *error) {
	...
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnTransDetach)(conn->handle, error->handle, flags);
...
//-----------------------------------------------------------------------------
int dpiOci__typeByName(dpiConn *conn, const char *schema, uint32_t schemaLength,
		const char *name, uint32_t nameLength, void **tdo, dpiError *error) {
	int status;
...
//-----------------------------------------------------------------------------
int dpiOci__typeByFullName(dpiConn *conn, const char *name, uint32_t nameLength,
		void **tdo, dpiError *error) {
	int status;

	DPI_OCI_LOAD_SYMBOL("OCITypeByFullName", dpiOciSymbols.fnTypeByFullName)
	DPI_OCI_ENSURE_ERROR_HANDLE(error)
	status = (*dpiOciSymbols.fnTypeByFullName)(conn->env->handle, error->handle,
			conn->handle, name, nameLength, NULL, 0,
			DPI_OCI_DURATION_SESSION, DPI_OCI_TYPEGET_ALL, tdo);
