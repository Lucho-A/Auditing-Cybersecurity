...
typedef void* (*dpiJznDom__loadFromInputEventSrc)(dpiJznDomDoc *jdoc,
		void *evtsrc);
typedef void* (*dpiJznDom__loadFromInputOSON)(dpiJznDomDoc *jdoc, void *octbsrc);
...
typedef int (*dpiJznDom__putItem)(dpiJznDomDoc *jdoc, void *arr, void *node,
		uint32_t pos);
typedef int (*dpiJznDom__appendItem)(dpiJznDomDoc *jdoc, void *arr, void *node);
typedef int (*dpiJznDom__replaceItem)(dpiJznDomDoc *jdoc, void *arr, void *node,
		uint32_t pos);
...
typedef void* (*dpiJznDom__newScalar)(dpiJznDomDoc *jdoc, dpiJznDomScalar *val);
...
//-----------------------------------------------------------------------------
int dpiDataBuffer__fromOracleDate(dpiDataBuffer *data, dpiOciDate *oracleValue);
int dpiDataBuffer__fromOracleDateAsDouble(dpiDataBuffer *data, dpiEnv *env,
...
int dpiMsgProps__setRecipients(dpiMsgProps *props, dpiMsgRecipient *recipients,
		uint32_t numRecipients, void **aqAgents, dpiError *error);
...
int dpiUtils__checkClientVersion(dpiVersionInfo *versionInfo, int minVersionNum,
...
int dpiUtils__ensureBuffer(size_t desiredSize, const char *action, void **ptr,
		size_t *currentSize, dpiError *error);
