...
void show_help(char *msgError){
	...
	printf("%s",C_WHITE);
	printf("\nUsage: auditing-cybersecurity [--help | --update | --discover] ip|url cantPortsToScan(1-5000) | --all | --port port [--no-intro]\n");
	printf("\nOptions:\n");
	...
	printf("-p | --port: scan just one port.\n");
	printf("-n | --no-intro: no 'Waking Up' intro.\n\n");
	printf("Examples: \n");
	printf("$ auditing-cybersecurity --discover --no-intro\n");
	printf("$ auditing-cybersecurity lucho-a.github.io 500\n");
	printf("$ auditing-cybersecurity lucho-a.github.io 30 -n\n");
	printf("$ auditing-cybersecurity lucho-a.github.io --all --no-intro\n");
	printf("$ auditing-cybersecurity lucho-a.github.io -p 2221 -n\n");
